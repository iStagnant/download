...
dotfilesrepo="https://github.com/iStagnant/dwmrice.git"
progsfile="https://raw.githubusercontent.com/iStagnant/download/master/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
sudo -u "$name" mkdir -p "/home/$name/.config/git"
